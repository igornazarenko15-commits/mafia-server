...
io.on('connection', (socket) => {
  ...
  // відправляємо повний стан новому клієнту
  ...
  socket.on('role:take:host', () => {
    ...
    // ставимо ведучого в слот 12 (idx 11)
    const hostSlot = room.slots[11];
    if (!hostSlot.socketId) hostSlot.socketId = socket.id;
  ...
  socket.on('role:take:player', () => {
    // знаходимо перший вільний слот серед 0-10
